...
from ..crystallography import HermiteNormalForms, HNFDecomposition, LLL, Lattice
...
def lat_cor(ibrava, pbrava, ibravm, pbravm, **kwargs):
    ...
    output = _sols_tostr(sols, nsol, dim, E_A, E_M, C_A, C_M, dist)
    if disp > 0:
        print(output)
...
def _sols_tostr(sols, nsol, dim, E_A, E_M, C_A, C_M, dist):
